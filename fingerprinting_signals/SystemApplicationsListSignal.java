...
public final class SystemApplicationsListSignal extends FingerprintingSignal<List<? extends PackageInfo>>
{
    ...
    public SystemApplicationsListSignal(final List<PackageInfo> value) {
    ...
    public String getHashableString() {
        ...
        final Iterator iterator = ((Iterable)CollectionsKt.sortedWith((Iterable)this.getValue(), (Comparator)new SystemApplicationsListSignal$getHashableString$$inlined$sortedBy.SystemApplicationsListSignal$getHashableString$$inlined$sortedBy$1())).iterator();
    ...
    public static final class Companion
    {
        ...
        public final FingerprintingSignal$Info getInfo() {
            return SystemApplicationsListSignal.access$getInfo$cp();
        }
    }
}
